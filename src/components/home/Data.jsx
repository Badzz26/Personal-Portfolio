...
const Data = () => {
  ...
  const toRotate = ["Web Development", "Programming", "Data Structures", "Algorithms", "Problem Solving"];
  ...
  return (
    <div className="home__data">
      ...
      {/* Changes here */}
      <h2 className="home__subtitle">Talks about <span className="styled__text">{" " + text}</span></h2>
      {/* Changes here */}

      <p className="home__description">
        I'm creative designer based in Gujarat, and I am very passionate and
